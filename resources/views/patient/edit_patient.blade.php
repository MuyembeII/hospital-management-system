		...
		<div class="columns is-multiline" data-aos="fade-in-up" data-aos-easing="linear">
			<div class="column is-8 is-offset-2">
				...
				<form action="{{ route('patients.update', $patient->id) }}" method="POST">
					...
					<h3 class="title is-6">Additional Client Details</h3>
						<div class="columns">
						    <!-- Column 1 -->
							<div class="column is-4">
								<!-- Input:  Birth Place -->
								...
								<div class="field">
									<div class="control">
										<label class="label" for="religion">Language</label>
										<div class="select is-fullwidth">
											<select name="language" id="language" class="regular-text">
												...
												<option value="Nyanja">Lozi</option>
												<option value="Nyanja">Tonga</option>
												<option value="Nyanja">Lunda</option>
												<option value="Nyanja">Lenje</option>
											</select>
										</div>
									</div>
								</div>
